...
class PaperMaterialCreate(BaseModel):
    ...
    tieu_chuan_dinh_luong: Decimal | None = None
    sai_so_pct: Decimal | None = None
    do_buc_tieu_chuan: Decimal | None = None
    do_nen_vong_tc: Decimal | None = None
    do_cobb_tieu_chuan: Decimal | None = None
    do_day_tieu_chuan: Decimal | None = None
