...
from app.routers import tai_san_in as tai_san_in_router
...
from app.routers import phieu_tra_hang as phieu_tra_hang_router
app.include_router(phieu_tra_hang_router.router)
...
from app.routers import delivery_post_tasks as _dpt_router
app.include_router(_dpt_router.router)
...
app.include_router(tai_san_in_router.router)
