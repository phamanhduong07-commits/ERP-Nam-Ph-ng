  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/production/cost-analysis', label: <Link to="/production/cost-analysis">Phân tích chi phí</Link>, roles: SAN_XUAT_FULL },
{ key: '/production/may-song', label: <Link to="/production/may-song">🌊 Máy Sóng</Link>, roles: SAN_XUAT_FULL },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/production/kho-loi', label: <Link to="/production/kho-loi">⚠️ Kho hàng lỗi/trả về</Link>, permissions: ['inventory.view', 'inventory.phoi_tp'] },
        ...
        { key: '/warehouse/can-cuon-giay', label: <Link to="/warehouse/can-cuon-giay">Cân giấy cuộn</Link>, permissions: ['inventory.import'] },
