      ...
      flyoutSections: [
        {
          items: [
            ...
            { key: '/production/phieu-tra-hang', to: '/production/phieu-tra-hang', label: <Link to="/production/phieu-tra-hang">Khách trả hàng</Link>, permissions: ['inventory.view', 'inventory.phoi_tp'] },
            ...
            { key: '/warehouse/production-sessions', to: '/warehouse/production-sessions', label: <Link to="/warehouse/production-sessions">Phiên sản xuất</Link>, permissions: ['inventory.import'] },
            { key: '/warehouse/production-session-report', to: '/warehouse/production-session-report', label: <Link to="/warehouse/production-session-report">📊 Báo cáo phiên SX</Link>, permissions: ['inventory.import'] },
            ...
            { key: '/warehouse/ton-dau-ky', to: '/warehouse/ton-dau-ky', label: <Link to="/warehouse/ton-dau-ky">Tồn đầu kỳ</Link>, permissions: ['inventory.adjust'] },
            { key: '/warehouse/so-nhap-xuat-ton', to: '/warehouse/so-nhap-xuat-ton', label: <Link to="/warehouse/so-nhap-xuat-ton">Sổ nhập xuất tồn</Link>, permissions: ['inventory.view'] },
            { key: '/warehouse/doi-soat-cuon', to: '/warehouse/doi-soat-cuon', label: <Link to="/warehouse/doi-soat-cuon">Đối soát cuộn giấy</Link>, permissions: ['inventory.import'] },
            { key: '/warehouse/the-kho', to: '/warehouse/the-kho', label: <Link to="/warehouse/the-kho">Sổ chi tiết / Thẻ kho</Link>, permissions: ['inventory.import'] },
          ],
        },
      ],
    },
