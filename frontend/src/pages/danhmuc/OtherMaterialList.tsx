...
export default function OtherMaterialList() {
  ...
  const createMut = useMutation({
    ...
    onError: (e: unknown) => message.error((e as ApiError)?.response?.data?.detail || 'Lỗi khi thêm vật tư'),
  })
  ...
  useHotkey('ctrl+n', openCreate, 'Thêm nguyên liệu khác mới')
  useHotkey('ctrl+s', handleSave, 'Lưu nguyên liệu', 'Trang hiện tại', modalOpen)
