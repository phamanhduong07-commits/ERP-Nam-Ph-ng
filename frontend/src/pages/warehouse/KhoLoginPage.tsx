...
export default function KhoLoginPage() {
  ...
  return (
    <div style={{
      ...
      background: 'linear-gradient(135deg, #002766 0%, #003a8c 60%, #1d39c4 100%)',
      padding: 16,
    }}>
      <Card style={{ width: 400, maxWidth: '100%', boxShadow: '0 16px 44px rgba(0,0,0,0.35)', borderRadius: 12 }}>
        <Space direction="vertical" style={{ width: '100%', textAlign: 'center' }} size={4}>
          ...
          <Title level={3} style={{ margin: 0 }}>Cân cuộn giấy</Title>
          <Text type="secondary">Đăng nhập để bắt đầu ca cân</Text>
        </Space>
        ...
        <Form form={form} onFinish={onFinish} style={{ marginTop: 28 }} size="large">
          ...
          <Form.Item style={{ marginBottom: 0 }}>
            <Button type="primary" htmlType="submit" loading={loading} block
              style={{ height: 52, fontSize: 18, fontWeight: 700, borderRadius: 8 }}>
              ⚖️ Vào cân cuộn giấy
            </Button>
          </Form.Item>
        </Form>
