...
export const warehouseApi = {
  ...
  btpTransferKanban: (data: { production_order_id: number; product_id: number; warehouse_xuat_id: number; warehouse_nhap_id: number; so_luong: number; don_gia: number; ten_hang?: string; ghi_chu?: string }) =>
